...
#define KC_APPLE_FN_KEY (KC_VERSION + 1)
#define KC_APPL KC_APPLE_FN_KEY
#define KC_NUMLK KC_NUM_LOCK

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,    KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,  KC_F12,  KC_SNAP, KC_SIRI, KC_LOCK,  KC_MUTE, KC_VOLD, KC_VOLU,
        KC_GRV,  KC_1,    KC_2,    KC_3,     KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,     KC_MINS, KC_EQL,  XXXXXXX, KC_BSPC, TG(1)  ,  KC_PSLS, KC_PAST, KC_PMNS,
        KC_TAB,  KC_Q,    KC_W,    KC_E,     KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_LBRC, KC_RBRC, KC_BSLS,          KC_HOME,  KC_UP,   KC_PGUP, XXXXXXX,
        KC_CAPS, KC_A,    KC_S,    KC_D,     KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT, KC_ENT,                    KC_LEFT,  KC_APPL, KC_RGHT, KC_PPLS,
        KC_LSFT, XXXXXXX, KC_Z,    KC_X,     KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH, KC_RSFT,          XXXXXXX, KC_END,   KC_DOWN, KC_PGDN, XXXXXXX,
        KC_LCTL, KC_LALT, KC_LGUI,                             KC_SPC,                             KC_RGUI,  KC_RALT, XXXXXXX, MO(2), KC_RCTL, XXXXXXX,  KC_INS,  KC_DEL,  KC_ENT
    ),

    [1] = LAYOUT(
        _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______,  _______, _______, _______,
        _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______,  KC_PSLS, KC_PAST, KC_PMNS,
    ...
    [2] = LAYOUT(
        ...
        XXXXXXX, XXXXXXX, QK_BOOT, KC_EECL,  XXXXXXX, KC_VERS, BL_STEP, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, BL_OFF,  XXXXXXX,          XXXXXXX, XXXXXXX,  BL_DEC,  XXXXXXX, XXXXXXX,
...
layer_state_t layer_state_set_user(layer_state_t state) {
    _show_caps_lock( layer_state_cmp(state, 2) );
    _show_num_lock( layer_state_cmp(state, 1) );
    return state;
}

bool led_update_user(led_t led_state) {
    _show_caps_lock( layer_state_is(2) || led_state.caps_lock );
    _show_num_lock( layer_state_is(1) || led_state.num_lock );
    return false;
}
